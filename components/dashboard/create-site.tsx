...
import { BrandLogo } from "../dashboard-v2/branding";
...
function CreateSiteModal({ open, isSiteLimitReached, onOpenChange }: CreateSiteModalProps) {
      ...
      {isSiteLimitReached ? (
        <DialogContent className="bg-white">
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              You have reached the maximum number of websites allowed. If you need more, please reach out to us on{" "}
              <a
                target="_blank"
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Note: Once set, the default language <span className="text-black font-medium">cannot</span> be
                  changed.
                </p>
              </div>
...
export function CreateSite({ isSiteLimitReached }: { isSiteLimitReached: boolean }) {
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="default" onClick={() => setShowCreateModal(true)} className="bg-black hover:bg-black/80">
