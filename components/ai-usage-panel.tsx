    ...
    <Tooltip open={open} onOpenChange={setOpen} delayDuration={5000}>
      ...
      <TooltipTrigger asChild>
        <div
          ...
          className={`w-11 -mx-1 h-max py-1 mb-2 flex items-center justify-center rounded cursor-pointer duration-200 ${remainingCredit < 4 ? "text-red-600 hover:bg-red-600/10" : "text-blue-600 hover:bg-blue-600/10"} ${remainingCredit > 0 ? "flex-col" : ""}`}>
          <BadgeDollarSign className="h-5 w-5 flex-shrink-0" size={12} />
