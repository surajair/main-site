...
export const getHomepageBlocks = async () => {
  return [
    ...
    },
    {
      _type: "Box",
      _id: "nofwpC",
      styles: "#styles:,flex-row flex justify-center items-center gap-2",
      tag: "div",
      backgroundImage: "",
      _parent: "zqDmDs",
      oldId: "yluCAz",
    },
    {
      ...
      _id: "BBCBzc",
      tag: "h5",
      styles: "#styles:,max-w-2xl text-lg text-muted-foreground leading-relaxed font-bold sm:text-xl",
    ...
    },
    {
      styles: "#styles:,",
      duration: 400,
      _type: "DarkModeToggle",
      _id: "tlkvgb",
      _name: "Dark Mode Toggle",
      _parent: "nofwpC",
      oldId: "adxprC",
    },
    {
